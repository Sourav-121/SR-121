...
## 🍉 Position Table: 
- For clarity, the table alternates between green and white rows. The green rows display the numerical values of the letters and digits, while the white rows show the letters and digits themselves.
<img src="./table.png">
